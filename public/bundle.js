...
var _MoodQuestion = __webpack_require__(83);

var _MoodQuestion2 = _interopRequireDefault(_MoodQuestion);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'question-box' },
          _react2.default.createElement(_MoodQuestion2.default, null)
        )
      );
    }
  }]);
...
var PromisedLocation = __webpack_require__(103);

var MoodQuestion = function (_Component) {
  _inherits(MoodQuestion, _Component);

  function MoodQuestion() {
    _classCallCheck(this, MoodQuestion);

    var _this = _possibleConstructorReturn(this, (MoodQuestion.__proto__ || Object.getPrototypeOf(MoodQuestion)).call(this));

    _this.state = {
      moodScore: 0
    };
    _this.submitMood = _this.submitMood.bind(_this);
    _this.handleOptionChange = _this.handleOptionChange.bind(_this);
    return _this;
  }

  _createClass(MoodQuestion, [{
    ...
    value: function submitMood(evt) {
      ...
      locator.then(function (position) {
        console.log("coordinates: ", position.coords);
        var lat = position.coords.latitude;
        var long = position.coords.latitude;
        return _axios2.default.post('/api/weather', {
          lat: lat,
          long: long,
          moodScore: _this2.state.moodScore
        });
      }).then(function (res) {
        return console.log("post succeeded!", res);
      }).catch(function (err) {
        return console.error('Position Error: ', err.toString());
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'jumbotron', id: 'mood-question' },
        _react2.default.createElement(
          'h1',
          { className: 'display-3' },
          'How ya feelin?'
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
